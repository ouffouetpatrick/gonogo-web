...
export class AddUtilisateurComponent implements OnInit {
    ...
    generateForm() {
        this.utilisateurEditForm = this._formBuilder.group({
            ...
            geler: [
                this.utilisateur ? this.utilisateur.geler : 0,
            ],
            dateCreation: [
                this.utilisateur ? this.utilisateur.dateCreation : new Date(),
            ],
            idusrcreation: [
                this.utilisateur ? this.utilisateur.idusrcreation : 1,
            ],
            // entreprise: [
            //     this.utilisateur ? this.utilisateur.entreprise : null,
            // ],
        });
    }
    ...
    save(): void {
        ...
        const utilisateur = {
            ...this.utilisateurEditForm.value,
    ...
    getUtilisateur(){
        this.routeSubscription = this.route.params.subscribe(params => {
            ...
            if(params){
                const getUtilisateurs = this.utilisateurService.query({ 
                    where: { id: +params['id'] },
                    relations: [
                        "utilisateurProfil",
                ...
                getUtilisateurs.subscribe((result) => { 
                    console.log(result, 'result-utilisateurrr');
    ...
    getDefaultValue(){
        if(this.utilisateur) {
            ...
            this.utilisateurEditForm.setValue({
